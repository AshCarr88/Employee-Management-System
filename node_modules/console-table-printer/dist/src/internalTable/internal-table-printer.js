...
const tablePreProcessors_1 = require("./tablePreProcessors");
...
function printTableAndGetConsoleOutput(table) {
    tablePreProcessors_1.preProcessColumns(table); // enable / disable cols, find maxLn of each col
    tablePreProcessors_1.preProcessRows(table); // sort and filter
    const ret = [];
